...
|#8    |UI Prototyp erstellen|Einen HTML/CSS Prototyp für die geplanten Ansichten erstellen                                                            |Jonas                |Erster Entwurf
|===
...
|#8    |Klassennamen finalisieren|Anschliessend mit Enumeratore in Pflichtenheft aufnehmen                                                          |alle                |ausstehend
|#8    |Pflichtenheft beenden|zu Version 1.0 ueberarbeiten                                                                                          |Lukas               |in Bearbeitung
|#8    |Group Prototype|Use Kickstarter Project
