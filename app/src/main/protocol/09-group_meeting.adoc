...
__Teilnehmer:__ Jeannine, Alfred, Oliver, Lukas
...
- [*] Beseitigung von Frontend-Problemen
- [*] Absprache zur Zwischenpräsentation
...
|#21    |Speiseplan GUI-Implementierun|Speiseplan-Dialog mittels Cards (MDL)                                                                        |Lukas               |ausstehend
|===