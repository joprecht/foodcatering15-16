...
class CartController {
	...
	public String deleteItem(@ModelAttribute Cart cart) {
		cart.clear();
		return "redirect:/cart";
	}
	
	@RequestMapping(value = "/decItem", method = RequestMethod.GET)
	public String decItem(@ModelAttribute Cart cart, @RequestParam("pid") String identifier) {
		
		if(cart.getItem(identifier).get().getQuantity().isGreaterThan(Quantity.of(0)))
		cart.addOrUpdateItem(cart.getItem(identifier).get().getProduct(), Quantity.of(-1));

		return "redirect:/cart";
	}
	
	@RequestMapping(value = "/incItem", method = RequestMethod.GET)
	public String incItem(@ModelAttribute Cart cart, @RequestParam("pid") String identifier) {
	...
	public String deleteOne(@ModelAttribute Cart cart, @RequestParam("pid") String identifier) {
		
		//cart.addOrUpdateItem(cart.getItem(identifier).get().getProduct(), Quantity.of(0));
